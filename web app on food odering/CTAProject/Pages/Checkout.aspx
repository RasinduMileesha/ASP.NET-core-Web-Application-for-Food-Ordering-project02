...
<body style=" text-decoration: none !important;overflow-x: hidden;">
    <form id="form1" runat="server">
        ...
        <div class="table-responsive-lg"  style="max-width:800px; min-width:300px; max-height:600px;min-height:350px;left:20%; box-shadow: 1px 1px 1px 1px gray;overflow-x: hidden; border-radius: 8px;">
            <div class="row" align="center" >
            ...
            <div class="row"  >
                <div class="col" >
                        ...
                        <asp:Panel ID="SidesPanel" runat="server"  CssClass="table-responsive-lg" style="text-decoration: none;max-width:800px;min-height:500px; min-width:800px;" ScrollBars="Vertical">                        
                             <div class="row"  >
                <div class="col" align="center" >
                    <br />
      ...
      <SelectedRowStyle BackColor="#B4D9FF" Font-Bold="True" />
       ...
       <asp:BoundField DataField="Cat" HeaderText="Cat"  />
        ...
        <asp:BoundField DataField="Total" HeaderText="Total" ItemStyle-Width="140px" />
            ...
            <ItemTemplate>
                <asp:Button ID="BtnRemove" runat="server" CommandName="RemoveRow" CommandArgument='<%# Container.DataItemIndex %>' Text="Remove" BackColor="#212F3C" ForeColor="White"  Style="border-radius: 11px;" Height="40px" Font-Bold="true" Width="100px" />
            </ItemTemplate>
        </asp:TemplateField>
        ...
        <asp:Panel ID="Panel2" runat="server" style="position: fixed;left: 0;bottom: 0;width: 100%;box-shadow: 1px 1px 1px 1px gray;">
             ...
             <div class="row">
                 <div class="col" style="padding:20px">
                     <asp:Button ID="ClearBtn" runat="server" Text="Clear All" Width="100%" BackColor="#212F3C" ForeColor="White" Font-Bold="true" Font-Size="Medium" CssClass="table-responsive-lg" Height="50px" BorderStyle="None" onclientclick="return confirm('Are you sure to Clear All?');" xmlns:asp="#unknown" OnClick="ClearBtn_Click"  />
                 
                 </div>

                 <div class="col" style="padding:20px">
                   
                     <asp:Button ID="CheckoutBtn" runat="server" Text="PAY" Width="100%" BackColor="#212F3C" ForeColor="White" Font-Bold="true" Font-Size="Medium" CssClass="table-responsive-lg" Height="50px" BorderStyle="None" OnClick="CheckoutBtn_Click" OnClientClick="showPaymentPanel(); return false;" />
                 </div>
                ...
                <div class="centered-panel">
                    ...
                    <div class="row" id="BTNPanel" runat="server">
                        <div class="col" style="padding:20px" align="left">
                            <asp:Button ID="CardBtn" runat="server" Text="Card" OnClick="CardBtn_Click" Height="100px" Width="100px" Font-Bold="True" Font-Size="Large" style="margin-left: 30px;" />
                            &nbsp; &nbsp; &nbsp; 
                            <asp:Button ID="Cashbtn" runat="server" Text="Cash" OnClick="Cash_Click" Height="100px" Width="100px" Font-Bold="True" Font-Size="Large" style="margin-left: 30px;" />
                        </div>
                        <div class="col" style="padding:20px" align="left">
                            <asp:Button ID="BTN500" runat="server" Text="500" Height="100px" Width="80px" Font-Bold="True" Font-Size="Large" OnClick="BTN500_Click" /> &nbsp; &nbsp;
                            <asp:Button ID="BTN1000" runat="server" Text="1000" Height="100px" Width="80px" Font-Bold="True" Font-Size="Large" OnClick="BTN1000_Click" /> &nbsp; &nbsp;
                            <asp:Button ID="BTN2000" runat="server" Text="2000" Height="100px" Width="80px" Font-Bold="True" Font-Size="Large" OnClick="BTN2000_Click" /> &nbsp; &nbsp;
                            <asp:Button ID="BTN5000" runat="server" Text="5000" Height="100px" Width="80px" Font-Bold="True" Font-Size="Large" OnClick="BTN5000_Click" />
                        </div>
                    </div>
                </div>
            </asp:Panel>
