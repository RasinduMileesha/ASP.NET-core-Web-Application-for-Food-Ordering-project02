...
<body style=" text-decoration: none !important;overflow-x: hidden;">
    ...
    <ContentTemplate>
       <%-- <asp:Label ID="lblItemDetails" runat="server" Text="fk"></asp:Label>--%>
                     ...
                     <asp:Button ID="AddToOrderBTN" runat="server" Text="Add to Order" Width="100%" BackColor="#212F3C" ForeColor="White" Font-Bold="true" Font-Size="Medium" CssClass="table-responsive-lg" Height="50px" BorderStyle="None" OnClick="AddToOrderBTN_Click"  />
                 </div>
