...
{
    public partial class JustItem : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            MainName= Convert.ToString(Request.QueryString["MenuName"]);
                ...
                if (!IsPostBack)
            {
                    ...
                    //  ItemImageView.Src = ItemImage;
                    //ImageArray = aManager_DAO.GetAllPastryImagesByID(ItemID);
                    ...
                    if (File.Exists(Server.MapPath("/ItemImages/" + ItemID + ".jpg")))
                    {
                        imgString = "/ItemImages/" + ItemID + ".jpg";
                    }
                    else
                    {
                        imgString = "/images/NOimage.png";
                    }
                    Image3.ImageUrl = imgString;
                    ItemNameLBL.Text = ItemName;
                    ItemPriceLBL.Text = ItemPrice;


                    CartButtonsPanel.Visible = true;
                    OrderDetails = Newtonsoft.Json.JsonConvert.DeserializeObject<CeylonAdaptor>(Session["" + SessionID + ""].ToString());
        ...
        protected void AddBtn_Click(object sender, EventArgs e)
        {
            ...
            if (int.TryParse(this.CountLBL.Text, out val))
            {
                ...
                else
                {
                    ...
                    ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "Reservation Error", "alert('Add Error')", true);
                }
            }
            else
            {
                    ...
                    try
                    {
                        ...
                        else
                        {
                            ...
                            for (int x = 0; x < GradeArray.Length; x++)
                            {
                                ...
                                str += "<a href='/Pages/JustItem.aspx?ssid=" + SessionID.ToString() + "&ItemID=" + GradeArray[x].FieldI1 + "&ItemName=" + GradeArray[x].FieldS1 + "&ItemPrice=" + GradeArray[x].FieldD1 + "&SubCat=" + GradeArray[x].FieldS3 + "&CATID=" + CATID + "&MainItemName=" + ItemName + "&MainName="+ MainName + "&ItemClicked=1' 'onclick='ShowLoading()'>";
                                ...
                                str += "<p style='color: black; font-size:15px; padding:1px;'> From Rs " + GradeArray[x].FieldD1 + " </p> ";
                                str += "</a>";
                                str += "</div>";
                                str += "</div>";
                                // }
        ...
        public void AddtoTempTable()
        {
            try
            {
                ...
                aBook.FieldS3 = CATID;// ItemType
                aBook.FieldS4 = MainName;// MenuName
        ...
        protected void AddToOrderBTN_Click(object sender, EventArgs e)
        {
            ...
            {
                CeylonAdaptor aBook = new CeylonAdaptor();
                aBook.FieldI1 = 0;//CartArray2[i].FieldI1; // SK
                ...
                aBook.FieldS3 = CartArray2[i].FieldS4;// CatName
