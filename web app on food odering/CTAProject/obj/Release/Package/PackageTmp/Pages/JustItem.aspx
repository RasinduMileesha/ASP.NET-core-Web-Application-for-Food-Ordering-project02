<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JustItem.aspx.cs" Inherits="CTAProject.Pages.JustItem" %>
...
<body style=" text-decoration: none !important;overflow-x: hidden;">
    <form id="form1" runat="server">
       ...
       <asp:GridView ID="GridView1" runat="server"  CssClass="table table-small-font table-bordered table-striped" Visible="false" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" >
      ...
      <div class="row" align="left"  >
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;  <asp:Button ID="BackBtn" runat="server" Text="Back" OnClick="BackBtn_Click" Width="90px"  BackColor="#78281F" ForeColor="White"  Style="border-radius: 11px;" Height="40px" Font-Bold="true"/>
              </div>
             <div class="col" align="right"  >
             <asp:Button ID="StartBtn" runat="server" Text="Start Again"  Width="90px" OnClick="StartBtn_Click" OnClientClick="return showConfirmation();" BackColor="#78281F" ForeColor="White"  Style="border-radius: 11px;" Height="40px" Font-Bold="true" />&nbsp;&nbsp;&nbsp;&nbsp;
                    </div>
          </div>
        ...
        <asp:Panel ID="CanBeMealPanel" runat="server" Visible="false">
         ...
         <br />
                   ...
                   <div class="row" align="center">
                     ...
                     <div class="col" align="center" id="div1" runat="server" >
                          <div class="row" align="center">
                     <div class="col"  align="center" >
